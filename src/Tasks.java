...
public class Tasks {
	public static void main(String[] args) {
		Actor willSmith = new Actor("Will Smith", new TreeSet<String>(Arrays.asList("Bad Boys", "Men in Black",
																				      "Six Degrees of Separation",
																				      "Showtime", "Jersey Girl")));
		Actor tommy = new Actor("Tommy Lee Jones", new TreeSet<String>(Arrays.asList("Love Story", "Men in Black",
				 																	   "Man of the House",
				 																	   "The Family")));
		Actor me = new Actor("Alex Horduz", new TreeSet<String>());
		Film jerseyGirl = new Film("Jersey Girl", new TreeSet<String>(Arrays.asList("Ben Affleck", "Liv Tyler",
																					  ...
																					  "Matthew Maher")));
		Film sleuth = new Film("Sleuth", new TreeSet<String>(Arrays.asList("Laurence Olivier", "Michael Caine",
	...
	private static boolean Task1() {
		TreeSet<Actor> actors = Films_DB.getActors();
	...
	private static TreeSet<String> Task2(Actor actor) {
		if (actor == null)
			throw new NullPointerException("NULL passed as a parameter");
		TreeSet<String> actorsToReturn = new TreeSet<String>();
		TreeSet<Film> allFilms = Films_DB.getFilms();
		TreeSet<String> actorsFilms = actor.getFilms();
		...
		TreeSet<Actor> allActors = Films_DB.getActors();
	...
	private static String Task3() throws Exception {
		...
		String theBiggestFilm = allFilms.first().getName();
		int maxActors = allFilms.first().getActors().size();
